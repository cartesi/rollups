...
pub fn get_host_server_manager_path() -> String {
    std::env::var("CARTESI_HOST_SERVER_MANAGER_PATH")
        .unwrap_or(String::from("target/debug/host-server-manager"))
}

pub fn get_test_verbose() -> bool {
    std::env::var("CARTESI_TEST_VERSBOSE").is_ok()
}
