...
#[path = "../../src/grpc/proto.rs"]
mod proto;

pub use proto::cartesi_machine::*;
pub use proto::server_manager::*;
pub use proto::versioning::*;

use super::config;

pub type ServerManagerClient =
    proto::server_manager::server_manager_client::ServerManagerClient<tonic::transport::Channel>;
