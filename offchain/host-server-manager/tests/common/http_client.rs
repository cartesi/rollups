...
pub use rollup_http_client::rollup::*;
...
pub async fn insert_notice(payload: String) -> Result<IndexResponse, HttpError> {
...
async fn handle_json_response<T: DeserializeOwned>(response: Response) -> Result<T, HttpError> {
