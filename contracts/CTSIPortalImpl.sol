...
import "./CTSIPortal.sol";
import "./Input.sol";

contract CTSIPortalImpl is CTSIPortal {
    address immutable outputContract;
    Input immutable inputContract;
    IERC20 constant CTSIContract = IERC20(0x491604c0FDF08347Dd1fa4Ee062a822A5DD06B5D);
    ...
    function ctsiDeposit(
        ...
        require(
            CTSIContract.transferFrom(_L1Sender, address(this), totalAmount),
        ...
        emit CTSIDeposited(_L1Sender, _L2receivers, _amounts, _data);
        ...
        onlyOutputContract
    {
        ...
        CTSIContract.transfer(receiver, value);

        emit CTSIWithdrawn(receiver, value);
    }
}
