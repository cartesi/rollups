...
1. As a **production environment** that provides a Cartesi Machine where the DApp back-end logic will run after been cross-compiled to the RISC-V architecture. Please check our [examples repository](https://github.com/cartesi/rollups-examples) that showcase Cartesi Rolllups usage.
