...
contract TestEpochHashSplitEnum is Test {
    ...
    function test_enumOfWaitingSubhashes() public {
        ...
        EpochHashSplitEnum.T memory enumWaitingSubhashes_ = EpochHashSplitEnum
            .enumOfWaitingSubhashes(waitingSubhashes_);
    ...
    function test_enumOfWaitingDivergence() public {
        ...
        EpochHashSplitEnum.T memory enumWaitingDivergence_ = EpochHashSplitEnum
            .enumOfWaitingDivergence(waitingDivergence_);

        assertTrue(
            EpochHashSplitEnum.isWaitingDivergenceVariant(
                enumWaitingDivergence_
            )
        );
    }
    ...
    function test_getWaitingSubhashesVariant() public {
        ...
        EpochHashSplitEnum.T memory enumWaitingSubhashes_ = EpochHashSplitEnum
            .enumOfWaitingSubhashes(waitingSubhashes_);
        EpochHashSplit.WaitingSubhashes
            memory recoveredWaitingSubhashes_ = EpochHashSplitEnum
                .getWaitingSubhashesVariant(enumWaitingSubhashes_);
        ...
        assertTrue(
            waitingSubhashes_.inputIndex ==
                recoveredWaitingSubhashes_.inputIndex
        );
    }
    ...
    function test_getWaitingDivergenceVariant() public {
        ...
        EpochHashSplitEnum.T memory enumWaitingDivergence_ = EpochHashSplitEnum
            .enumOfWaitingDivergence(waitingDivergence_);
        EpochHashSplit.WaitingDivergence
            memory recoveredWaitingDivergence_ = EpochHashSplitEnum
                .getWaitingDivergenceVariant(enumWaitingDivergence_);

        assertTrue(
            Merkle.Hash.unwrap(waitingDivergence_.preAdvanceMachine) ==
                Merkle.Hash.unwrap(
                    recoveredWaitingDivergence_.preAdvanceMachine
                )
        );
        assertTrue(
            Merkle.Hash.unwrap(waitingDivergence_.preAdvanceOutputs) ==
                Merkle.Hash.unwrap(
                    recoveredWaitingDivergence_.preAdvanceOutputs
                )
        );
        assertTrue(
            Merkle.Hash.unwrap(waitingDivergence_.postAdvanceMachineClaim) ==
                Merkle.Hash.unwrap(
                    recoveredWaitingDivergence_.postAdvanceMachineClaim
                )
        );
        assertTrue(
            Merkle.Hash.unwrap(waitingDivergence_.postAdvanceOutputsClaim) ==
                Merkle.Hash.unwrap(
                    recoveredWaitingDivergence_.postAdvanceOutputsClaim
                )
        );
        assertTrue(
            waitingDivergence_.inputIndex ==
                recoveredWaitingDivergence_.inputIndex
        );
    }
