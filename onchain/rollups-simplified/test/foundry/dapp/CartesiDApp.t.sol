...
contract CartesiDAppTest is TestBase {
    ...
    function testEtherTransfer(uint256 _inputIndex) public {
        ...
        vm.expectRevert("re-execution not allowed");
        dapp.executeVoucherV1(address(dapp), withdrawEtherPayload, "", proof);
    }
