...
interface OutputValidityProofV2 {
    outputIndex: number;
...
function setupNoticeProof(epochInputIndex: number): OutputValidityProofV2 {
    ...
    let noticeProof: OutputValidityProofV2 = {
        outputIndex: 0,
...
function buildSolCodes(noticeProof: OutputValidityProofV2, libraryName: string): string {
    ...
    const lines: string[] = [
        ...
        "",
        `library ${libraryName} {`,
        "    function getOutputProofV2() internal pure returns (OutputValidityProofV2 memory) {",
